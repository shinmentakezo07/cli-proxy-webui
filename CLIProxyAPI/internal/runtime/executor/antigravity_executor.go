...
// antigravityClientID and antigravityClientSecret are read from the environment
// so the credentials are not embedded in source. Set ANTIGRAVITY_OAUTH_CLIENT_ID
// and ANTIGRAVITY_OAUTH_CLIENT_SECRET to enable the Antigravity provider.
var (
	antigravityClientID     = os.Getenv("ANTIGRAVITY_OAUTH_CLIENT_ID")
	antigravityClientSecret = os.Getenv("ANTIGRAVITY_OAUTH_CLIENT_SECRET")
)
